...
[] Host Machine: x86-64 PC/MiniPC (Always-on, wired Ethernet prefered)
...
[] Logic Structure: 100% of complex logic handles via .py files (no UI-based Node-RED/YAML automations)
